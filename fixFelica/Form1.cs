    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            using (Felica f = new Felica())
            {
                ...
                Block00 = Encoding.Default.GetBytes("abc123");
                Console.WriteLine("byte array is:" + String.Join("", Block00));


                mozi = System.Text.Encoding.UTF8.GetString(Block00);

                Console.WriteLine("the string is" + mozi);
